...
void AABCharacterBase::ApplyStat(const FABCharacterStat& InBaseStat, const FABCharacterStat& InModifierStat)
{
	const float MovementSpeed = (InBaseStat.MovementSpeed + InModifierStat.MovementSpeed);
